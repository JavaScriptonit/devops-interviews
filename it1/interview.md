...
## 20. Приходится вести репозиторий с helm-charts. Открыли ветку. Добавили правку. Делаем merge и получаем конфликт. Как решить конфликт?
...
## Продолжить (ИТ1 тех собес 1/2) с 0:33:35