...
## 14. Как вы понимали что релиз удачный? Выводим что-то на прод. Как понять что всё прошло хорошо? (k8s)
...
## 15. Достаточно ли будет проверить вручную или в пайплайне статус релиза через Хелм? (helm) (k8s)
...
## 16. Когда мы проверяем статус релиза и там написано: "Статус - Deployed". О чем нам это говорит? (helm) (k8s)
...
## 17. Может быть такая ситуация что "Статус - Deployed", но при этом поды не работают или работают неправильно. Что делать чтобы этого избежать? (helm) (k8s)
...
## 18. Ставим 3 реплики приложения. Заходим, а их 5 в кубере. Как будешь понимать какая реплика к какой версии относится? (helm) (k8s)
...
## 19. Ставим 3 реплики приложения. Заходим, а их 5 в кубере. Как такое может произойти при деплое? (helm) (k8s)
...
## 20. Работал ли с сервис мешом, например, Истио? (k8s)
...
## 21. Приведи пример использования Istio, команды для его работы. (k8s)
...
## 22. Istio работает только с кубом или можно использовать и для приложений развёрнутых в докер без куба? (Istio)
...
## 23. Какие еще популярные сервис-мешы бывают? (Istio)
...
## 24. Сертификаты. Что такое mTLS? Работал ли с ним? (tls)
...
## 25. Чем сотрудник DevOps должен выпускать сертификаты на серверах Ubuntu, MacOS, CentOS? (openssl)
...
## 26. Приведи примеры создания сертов. (openssl)
...
## 27. Приведи примеры создания сертов. (openssl) (k8s)
...
## 28. Передавал ли при создании сертификата параметр - роль? (openssl) (k8s)
...
## 29. Серверные серты. Надо выпустить 1 или 10 сертов под 10 ингрессов? (openssl) (k8s)
...
## 31. Что напишешь в сертификате в поле SN для такого случая? (openssl) (k8s)
...
## 33. Расскажи про сигналы в Linux. (Linux)
...
## 33. Какие бывают виды сигналов в Linux? (Linux)
...
## 34. Писал ли сложную логику на bash с использованием массивов? (bash)
...
2) Вот пример скрипта на Bash, который использует массив для хранения списка файлов в директории и выводит их на экран:
...
## Продолжить (IT1. Знакомство с командой 1/1) с 00:21:53