...
## 11. В каких случаях будет происходить фрагментация пакетов? Есть ли фрагментация в UDP и TCP? Что такое MTU сетевого интерфейса? Приведи пример фрагментации пакетов исходя из MTU сетевого интерфейса
