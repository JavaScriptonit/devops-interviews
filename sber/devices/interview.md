...
Для хранения больших объемов данных можно использовать специализированные хранилища, такие как `Amazon S3`, G`oogle Cloud Storage` или `MinIO`.
...
# Продолжить с 2мя записями в диктофоне