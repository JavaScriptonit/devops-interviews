...
## 15. Можно ли заменить кавычки "" другим символом?
```
for ((i=1; i<=10; i++))
do
  filename="${path}/${i}a"
...
## 2. Какую CI выберешь в собственной компании и почему?
...
## 3. Как заменить drod-down menu Jenkins и GitHub в GitLab для параметризованной сборки?
...
## 4. Что показывает команда "git log -100" при "git merge" и "git rebase"?
