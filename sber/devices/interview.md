...
## 13. Чем лучше оркестрация k8s в сравнении с systemd units и ansible, заменит ли оркестрацию?
...
## 14. Написать код на bash, который создаст 10 файлов по заданному пути с названиями: 1a, 2a и тд
...
## Продолжить "Тех собес Сбер devices 2/2" с 00:00 мин